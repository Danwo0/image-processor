...
public class ImageProcessorModelImplTest {
  ...
  public void setUp() {
    ...
    try {
      ...
      pixBlur = Files.readString(Paths.get("res/pixBlur.ppm"));
      pixSharpen = Files.readString(Paths.get("res/pixSharpen.ppm"));
      pixSepia = Files.readString(Paths.get("res/pixSepia.ppm"));
